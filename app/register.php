...
try {
    ...
    $google_error = "Google Sign-In is temporarily unavailable. Please use email/password to register or try again later.";
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user) {
        ...
        $query = "INSERT INTO users (username, email, password, full_name, address, phone) 
                  VALUES('$username', '$email', '$hashed_password', '$full_name', '$address', '$phone')";
...
<head>
    ...
    <title>Register - Art Delivery</title>
            ...
            <?php else: ?>
                ...
                <form action="register.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control form-control-with-icon" name="email" placeholder="Email" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-with-icon" name="full_name" placeholder="Full Name" required>
                    </div>
                    <div class="form-group">
                        <i class="fas fa-map-marker-alt input-icon"></i>
                        <textarea class="form-control form-control-with-icon" name="address" placeholder="Delivery Address" required rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <i class="fas fa-phone input-icon"></i>
                        <input type="tel" class="form-control form-control-with-icon" name="phone" placeholder="Phone Number" required>
                    </div>
